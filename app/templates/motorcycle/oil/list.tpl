<h1>Oil Exchanges</h1>
<a href="#motorcycle/oil/new" class="btn btn-success"><i class="glyphicon glyphicon-plus glyphicon-white"></i> New</a>
...
<div class="tab-content">
    <div id="status" class="tab-pane active">
        <table class="table table-bordered table-hover">
            <caption><strong><em>Oil Exchange's Status in this Cycle</em></strong></caption>
            <thead>
                <tr>
                    <th>Status</th>
                    <th>#</th>
...
<!-- <h1>Oil Exchange</h1> -->
<!-- <a href="#motorcycle/oil/new" class="btn btn&#45;success"><i class="icon&#45;plus icon&#45;white"></i> New</a> -->
<!-- <a href="#" class="btn btn&#45;warning"><i class="icon&#45;refresh icon&#45;white"></i> Sync</a> -->
<!-- <br /> -->
<!-- <br /> -->
<!-- <table class="table table&#45;striped table&#45;bordered table&#45;hover"> -->
<!--     <caption> -->
<!-- 	    <strong><em>Oil Exchange</em></strong> -->
<!-- 	</caption> -->
<!-- 	<thead> -->
<!-- 	    <tr> -->
<!-- 			<th>KM</th> -->
