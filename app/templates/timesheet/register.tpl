...
<div id="divRegister">
    ...
    <input type="text" id="inputStartTime" class="input-small timeMask" value="{{startTime}}" placeholder="hh:mm:ss" data-bind="value:startTime,events:['keyup']"/>
    ...
    <input type="text" id="inputEndTime" class="input-small timeMask" value="{{endTime}}" placeholder="hh:mm:ss" data-bind="value:endTime,events:['keyup']" />
    ...
    <input type="text" id="inputLeavingEarly" class="input-small" value="{{leavingEarly}}" placeholder="hh:mm:ss" data-bind="value:leavingEarly,events:['keyup']" />
